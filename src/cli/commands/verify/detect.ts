// Implements "chaosclaw verify detect" â€” the runtime detection primitive.
...
/**
 * Attaches the "detect" subcommand to the verify command group.
 * @param verify The verify command group to attach to.
 */
export function detect(verify: Command): void {
    verify
        .command('detect')
